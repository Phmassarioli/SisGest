  ...
  <div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title title-color-red"> Consultar Gasto Especifico Dentro do Periodo</h5>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="cadastro">
                ...
                <label class="control-labe" for="inputWarning">Data Inicio</label>
                <input class="form-control" type="date" id="$data" name="data" OnKeyPress="formatar('##/##/##', this)" />
                <br>

                <label class="control-label" for="inputWarning">Data Fim</label>
                <input class="form-control" type="date" id="$dataf" name="dataf" OnKeyPress="formatar('##/##/##', this)" />
                <br>

                <label class="control-label" for="inputWarning">Nome do Gasto</label>
                <input class="form-control" type="text" id="nomegasto" name="nomegasto">
                <br>

                <button type="submit" id="btok" class="btn btn btn-danger"><?php echo $texto_botao; ?></button>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title title-color-red">Gastos Dentro do Periodo</h5>
          </div>
          <div class="card-body">
            <div class="table-responsive ">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM gastos WHERE nomegasto='$nomegastos' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC";
                ...
                <div class="table-responsive ">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $total = mysqli_query($con, "SELECT SUM(valorgasto)  FROM gastos WHERE nomegasto='$nomegastos' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");
                      $MediaDia = mysqli_query($con, "SELECT SUM(valorgasto)  FROM gastos WHERE nomegasto='$nomegastos' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");
