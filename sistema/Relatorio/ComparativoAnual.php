                                ...
                                <div class="table-responsive ">
                                  <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                      //Consulta de Valores Agrupados no Banco de Dados
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card">
                                      <div class="card-header">
                                        <h5 class="title title-color-red">Comparativo de Contas Pagas Dentro do Ano de <?php echo $ano ?></h5>
                                      </div>
                                      <div class="card-body">
                                        <div class="table-responsive ">
                                          <thead class=" text-primary">
                                            ...
                                            <div class="col-md-12"><img alt="" src="../Graficos/GraficoContas.php" title=""></div>
                                              ...
                                              <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="card">
                                                      <div class="card-header">
                                                        <h5 class="title title-color-red"> Comparativo de Gastos Dentro do Ano de <?php echo $ano ?></h5>
                                                      </div>
                                                      <div class="card-body">
                                                        <div class="table-responsive ">
                                                          <thead class=" text-primary">
                                                            ...
                                                            <div class="col-md-12"><img alt="" src="../Graficos/GraficoGastos.php" title=""></div>
                                                      ...
                                                      <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-12">
                                                            <div class="card">
                                                              <div class="card-header">
                                                                <h5 class="title title-color-red">Comparativo de Contas Pagas + Gastos Dentro do Ano de <?php echo $ano ?></h5>
                                                              </div>
                                                              <div class="card-body">
                                                                <div class="table-responsive ">
                                                                  <thead class=" text-primary">
                                                                    ...
                                                                    <div class="col-md-12"><img alt="" src="../Graficos/GraficoContasGastos.php" title=""></div>
                                                            ...
                                                            <div class="row">
                                                              <div class="col-md-12">
                                                                ...
                                                                <a href="../Relatorio/ComparativoAnualAnterior.php" class="btn btn-primary">
                                                                  <i></i>
