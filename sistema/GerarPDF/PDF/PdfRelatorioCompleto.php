...
$sql = "SELECT * FROM ganhos ORDER BY data ASC";
...
$sql = "SELECT nomeganho, SUM(valor) AS valor FROM ganhos GROUP BY nomeganho";
$uquery = mysqli_query($con, $sql);
$total_usuarios = mysqli_num_rows($uquery);
...
$sql = "SELECT * FROM contasfixas ORDER BY data ASC";
$uquery = mysqli_query($con, $sql);
$total_usuarios = mysqli_num_rows($uquery);
while ($lncp = mysqli_fetch_object($uquery)) :
  $ucod[] = $lncp->cod;
...
$sql = "SELECT nomeconta, SUM(valor) AS valor FROM contasfixas GROUP BY nomeconta";
$uquery = mysqli_query($con, $sql);
$total_usuarios = mysqli_num_rows($uquery);
...
$sql = "SELECT * FROM gastos ORDER BY data ASC";
$uquery = mysqli_query($con, $sql);
$total_usuarios = mysqli_num_rows($uquery);
while ($lncp = mysqli_fetch_object($uquery)) :
  $ucodgasto[] = $lncp->cod;
...
$sql = "SELECT nomegasto, SUM(valorgasto) AS valorgasto FROM gastos GROUP BY nomegasto";
$uquery = mysqli_query($con, $sql);
$total_usuarios = mysqli_num_rows($uquery);
...
$totalganhos = mysqli_query($con, "SELECT SUM(valor)  FROM ganhos ORDER BY data ASC");
...
$ctotal = mysqli_query($con, "SELECT SUM(valor)  FROM contasfixas ORDER BY data ASC");
...
$gtotal = mysqli_query($con, "SELECT SUM(valorgasto)  FROM gastos ORDER BY data ASC");
...
$totalcofre = mysqli_query($con, "SELECT SUM(valortotal)  FROM cofre ORDER BY data ASC");
...
//Consulta e Soma de Valores do Banco de Dados
$totalresgate = mysqli_query($con, "SELECT SUM(valor)  FROM resgatecofre ORDER BY data ASC");
