      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title title-color-green"> Consultar Ganho Especifico Dentro do Periodo</h5>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="cadastro">
                ...
                <label class="control-label" for="inputWarning">Nome do Ganho</label>
            ...
            <div class="table-responsive ">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM ganhos WHERE nomeganho='$nomeganho' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC";
                ...
                <div class="table-responsive ">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $total = mysqli_query($con, "SELECT SUM(valor)  FROM ganhos WHERE nomeganho='$nomeganho' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");
                      $MediaDia = mysqli_query($con, "SELECT SUM(valor)  FROM ganhos WHERE nomeganho='$nomeganho' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");
