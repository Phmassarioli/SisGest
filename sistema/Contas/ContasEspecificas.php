...
// Coleta de dados Inseridos no Formulario para Consulta no Banco de Dados

if (isset($_POST['usuario'])) {

  $data = $_POST["data"];
  $dataf = $_POST["dataf"];
  $nomecontas = $_POST["nomeconta"];
}
  ...
  <div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title title-color-red"> Consultar Conta Especifica Dentro do Periodo</h5>
          </div>
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title title-color-red">Contas Pagas Dentro do Periodo</h5>
          </div>
          <div class="card-body">
            <div class="table-responsive ">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM contasfixas WHERE nomeconta = '$nomecontas' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC";
                  ...
                  <table class="table">
                    <thead class=" text-primary">
                      <tr>
                        ...
                        <th class="datatable-color">Média Dia</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      $total = mysqli_query($con, "SELECT SUM(valor)  FROM contasfixas WHERE nomeconta = '$nomecontas' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");

                      // Consulta e Calculo da Media de Valores em dias Contados

                      $mediaDia = mysqli_query($con, "SELECT SUM(valor)  FROM contasfixas WHERE nomeconta = '$nomecontas' AND data >='$data' AND data <= '$dataf' ORDER BY data ASC");
