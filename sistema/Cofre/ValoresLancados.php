      ...
      <div class="col-md-12">
            ...
            <div class="table-responsive ">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM cofre WHERE data >='$data' AND data <= '$dataf' ORDER BY data ASC";
        ...
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="table-responsive ">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $total = mysqli_query($con, "SELECT SUM(valortotal) FROM cofre WHERE data >='$data' AND data <= '$dataf' ORDER BY data ASC");

                      //Consulta e Soma de Valores do Banco de Dados
                      $mediaDia = mysqli_query($con, "SELECT SUM(valortotal) FROM cofre WHERE data >='$data' AND data <= '$dataf' ORDER BY data ASC");
            ...
            <a href="ValorEspecifico.php" class="btn btn-success">
              <i></i>
              Consultar Valor Especifico
            </a>
